          ...
          children: [
            ...
            DefaultTextStyle(
              ...
              child: const Row(
                ...
                children: [
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('Receitas'), Text('Despesas')]),
                  Column(crossAxisAlignment: CrossAxisAlignment.end, children: [Text('R\$ 3.000,00'), Text('R\$ 1.800,00')]),
                ],
              ),
            ),
          ],
